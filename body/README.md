...
Plain node: the HTTP bridge on `127.0.0.1:8642`, the queue, the intents, the display
...
Rust overlay on the screen (XWayland) — as the eye. Electron is not resident: it
